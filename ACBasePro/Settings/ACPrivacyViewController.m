...
- (void)_initView {
    UIScrollView *sv = [[UIScrollView alloc] initWithFrame:CGRectMake(0, NAVI_BAR_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT - TAB_BAR_INTERVEL - NAVI_BAR_HEIGHT)];
    ...
    UILabel *lab = [ACUITools createLabel:sv frame:CGRectMake(16, 12, gw(sv) - 32, 20) text:str textColor:UIColor.blackColor font:PF_Regular_Font(13) alignment:NSTextAlignmentLeft];
    lab.numberOfLines = 0;
    [lab sizeToFit];
    [sv setContentSize:CGSizeMake(SCREEN_WIDTH, gh(lab) + 24)];
}
